...
// Signing google
export const signInGoogleRequest = (state = INITIAL_STATE) => ({
  ...state,
  loading: true
});
export const signInGoogleSuccess = (state = INITIAL_STATE) => ({
  ...state,
  loading: false,
  error: null
});
export const signInGoogleFailure = (state = INITIAL_STATE, { error }) => ({
  ...state,
  loading: false,
  error
});
...
// SignOut
export const signOutRequest = (state = INITIAL_STATE) => ({
  ...state,
  loading: true
});
...
export const signOutFailure = (state = INITIAL_STATE, { error }) => ({
  ...state,
  user: null,
  error,
  loading: false
